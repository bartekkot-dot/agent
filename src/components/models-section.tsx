      ...
      <Container>
        <Reveal>
          ...
          <div className="mx-auto mt-12 grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            {content.models.providers.map((provider) => (
              <div
                key={provider.name}
                className="flex flex-col items-center justify-center gap-1 rounded-xl border border-border/60 px-3 py-5 text-center"
              >
